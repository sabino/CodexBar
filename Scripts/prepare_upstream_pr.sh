...
echo "  - Fork-specific features (multi-account, etc.)"
    echo "  - Fork release metadata or sabino/CodexBar-Native-specific documentation"
...
echo "6. Create PR on GitHub:"
    echo "   ${GREEN}https://github.com/steipete/CodexBar/compare/main...sabino:$BRANCH_NAME${NC}"
echo ""
